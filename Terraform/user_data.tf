...
install -o root -g root -m 0755 kubectl /usr/local/bin/kubectl -y
...
git clone https://oauth2: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@github.com/ize1020/kandula-app-8.git
cd /kandula-app-8
